...
For further details, please refer to [provided resources](./provided-resources.md), [ER diagram](./ER_diagram.png), and [docker-compose](./docker-compose-candidate.yml).
